...
<?php 
  ...
  $query = "SELECT * FROM clubs where name = 'Football'";
  $result = mysqli_query($conn, $query) or die ( mysqli_error($conn));
  $row = mysqli_fetch_assoc($result);
?>

<!-- Football club description starts -->
<div class="container">
      <div class="row">
        <div class="col-md-6">
            <br><br>
          ...
          <div class="col-md-6" style="justify-content:center;">
            <br><br>
            <img src="image/football_club.jpeg" class="img-fluid">
          </div>
      </div>
    </div>
<!-- Football club description ends -->
