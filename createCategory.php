...
if(isset($_POST['new']) && $_POST['new']==1)
{
      ...
      if (isset($_POST['active']))
        ...
        $checkCategory = "SELECT * FROM category WHERE name LIKE '%$categoryName%';";
        ...
        $sql = "INSERT INTO category (name,  active) VALUES ('$categoryName', '$isActive')";

        mysqli_query($conn,  $sql) or die(mysqli_error($conn));
        $status = "<div class='container'> Record Created Successfully. <br><br>
        <a href='categoryList.php'> View Created Record</a>";
...
?>
    <form action="" method="post">
        <div class="container">
          ...
          <input type="text" placeholder="Category Name" name="categoryName" id="categoryName" required><br>          
